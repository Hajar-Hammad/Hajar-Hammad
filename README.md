...
CS & Engineering graduate who builds with purpose —
from AI-powered assistive apps to workflow automation.
I believe technology should include everyone.

```yaml
currently : AI · n8n · Digital Transformation
building  : Wasl — AI assistive app for the visually impaired
```
